...
setup(
    name='sulekha_holtwinters_python',  # Required
    version='1.4.0',  # Required
    description='A Holt Winters implementation Python project using Pandas Dataframe',  # Required
    long_description=long_description,  # Optional
    url='https://github.com/sulekhaaloorravi-python/sulekha_holtwinters_python',  # Optional
    ...
    package_data={  # Optional
        'sulekha_holtwinters_python': ['data'],
    }
)
